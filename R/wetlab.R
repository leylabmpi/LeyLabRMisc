...
#'
#' @return named vector (Well --> location); column-wise location
...
#' Convert between wellID and column-num
#'
#' Useful for converting between WellIDs (eg., "A2")
#' and well position in a plate (eg., 9)
#'
